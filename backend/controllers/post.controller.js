...
export const createPost = async (req, res) => {
  try {
    // Try both req.auth and req.auth() for debugging
    ...
    if (typeof req.auth === 'function') {
      ...
      // If req.auth is not a function, fallback or error
      return res.status(401).json("Clerk auth not available or misconfigured");
    }
  } catch (err) {
